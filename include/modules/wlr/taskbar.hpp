...
class Task {
 ...
 private:
  std::string cached_workspace_id_ = "1";  // Changed default to "1" instead of "0"
  bool workspace_cache_invalid_ = true;
  std::chrono::steady_clock::time_point last_workspace_fetch_;
